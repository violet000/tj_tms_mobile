...
class BoxHandoverVerifySuccessPage extends StatefulWidget {
  ...
  @override
  State<BoxHandoverVerifySuccessPage> createState() =>
      _BoxScanVerifySuccessPageState();
}

class _BoxScanVerifySuccessPageState extends State<BoxHandoverVerifySuccessPage>
  ...
  Widget build(BuildContext context) {
    final boxHandoverProvider = context.watch<BoxHandoverProvider>();
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInfoRow(
                            '款箱数量',
                            '${boxHandoverProvider.boxItemsCount}',
                          ),
                          const SizedBox(height: 12),
                          _buildInfoRow(
                            '交接网点',
                            lineInfoProvider.getOrgName.isNotEmpty
